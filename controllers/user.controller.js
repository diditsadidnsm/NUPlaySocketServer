...
module.exports = (io, socket) => {
    ...
    //     let satu = page * 25;
    //     let dua = 25;
    //     let getData = await user.getRecommended(satu, dua).catch(err =>{ return {success: false, errors: err}});
    //     if (!getData.success){
    //         res.success = false;
    ...
    //     let satu = page * 25;
    //     let dua = 25;
    //     let getData = await user.getData().catch(err =>{ return {success: false, errors: err}});
    //     if (!getData.success){
    //         res.success = false;
    //         res.message = "failed - response server error. Err code: LRV00001";
    //         return callback(res);
